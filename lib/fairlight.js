...
/**
 * Which "Mic N" an analog audio input is. The two analog inputs read "Mic 1"/"Mic 2" in ATEM
 * Software Control, but their Fairlight input ids are model-specific — 1001/1002 on the G2, but
 * 1301/1302 on the ATEM Mini Extreme ISO — so number them by their order among the AudioIn inputs,
 * the way the switcher itself does, rather than by any hard-coded id range.
 */
